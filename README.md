...
- **Сервер (Backend)**: API на Node.js, Express и Socket.IO (в папке `/server`) для обмена сообщениями в реальном времени, с аутентификацией и файловой базой данных.
...
5.  Раскройте секцию **Environment Variables** и добавьте новую переменную:
    ...
    - **Value**: Вставьте URL вашего **сервера с Render** из предыдущего шага (например, `https://messenger-backend-xyz.onrender.com`). **Не добавляйте `/api` в конце!**
